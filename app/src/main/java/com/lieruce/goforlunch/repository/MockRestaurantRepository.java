...
public class MockRestaurantRepository implements RestaurantRepository {
    ...
    private void initMockData() {
        ...
        addMock("mock_3", "Sushi Master", "8 Boulevard Saint-Germain, Paris", 4.8, 48.8510, 2.3520, "Closed - Opens 11:30", "01 11 22 33 44", null, "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=800");
